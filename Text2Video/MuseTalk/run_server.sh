...
CUDA_VISIBLE_DEVICES=2 /root/zhuxiaoxu/abc/miniconda3/envs/gs/bin/python -m scripts.realtime_inference_streaming  --inference_config configs/inference/realtime_streaming_server.yaml --batch_size 4
