...
class FaceParsing():
    ...
    def model_init(self, 
                   resnet_path='/root/zhuxiaoxu/code/MuseTalk/musetalk/models/face-parse-bisent/resnet18-5c106cde.pth', 
                   model_pth='/root/zhuxiaoxu/code/MuseTalk/musetalk/models/face-parse-bisent/79999_iter.pth'):
